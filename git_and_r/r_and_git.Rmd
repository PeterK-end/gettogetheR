...
- Programm zur Versionskontrolle
  ...
  - Änderungen werden Schrittweise durchgeführt (Commit)
  - Änderungen können Rückgängig gemacht werden (Revert)
  - Ältere Versionen des Projekts können wieder hergestellt werden (Reset)
  - Verschiedene Versionen des Projekts können gleichzeitig bearbeitet werden und später zusammengeführt (Branching/Merging)
...
\begin{column}{0.5\textwidth}
   \begin{itemize}
      ...
      \item GitHub bietet unglaublich viel Potential für weitere Anwendungsfälle (Aufgabenplanung, Release, Continious Integration)
   \end{itemize}
\end{column}
\begin{column}{0.5\textwidth}
    \begin{center}
